            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        ...
                        <h3 class="text-dark">Add Blog Topic</h3>
                            <!-- message display -->
                        ...
                        <form method="POST" action="create.php" class="container">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $name; ?>" name="name" class="form-control" id="" aria-describedby="">
                    ...
                    <textarea name="description" id="editor"></textarea>
                            ...
                            <!-- <div name="decription" id="div_editor1">
                                <p>This is a default toolbar demo of Rich text editor.</p>
                                <p><img src='../../assets/download/docs/images/editor-image.png' /></p>
                            </div> -->

                            <div class="form-group">
                                <label for="comment">Topic Content</label>
                                
                                <textarea name="description" value="<?php echo $description ?>" class="form-control" rows="5" id="body">
                            ...
                            <button type="submit" name="add_topic" class="btn mb-4 btn-primary">Submit Topic</button>
                        </form>
