...
<?php include(IN_DIR . "../app/controllers/topics.php"); ?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        ...
                        <h3 class="text-dark">Edit Blog Topic</h3>
                            <!-- message display -->
                            <?php include(IN_DIR . "/app/helpers/formErrors.php"); ?>

                        <div>
                            <a href="create.php" class="btn p-2 mx-0 my-5 btn-outline-primary">Add Topic</a>
                            <a href="index.php" class="btn p-2 mx-2 my-5 btn-outline-secondary">Manage Topics</a>
                        </div>
                        ...
                        <form method="POST" action="edit.php" class="container">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="<?php echo $name; ?>" class="form-control" id="" aria-describedby="">
                                <small id="" class="form-text text-muted">We'll never share your email with anyone else.</small>
                            </div>

                            <!-- <label>Describe the issue in detail</label>
                    <div class="form-group">
                    <textarea name="description" value="<?php // echo $description; ?>" id="editor"></textarea>
                </div> -->
                            <!-- <div name="description" value="<?php //echo $description; ?>" id="div_editor1">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" value="<?php echo $description; ?>" class="form-control" rows="5" id="body"></textarea>
                            </div>

                            <button type="submit" name="update_topic" class="btn my-4 btn-primary">Update Topic</button>
                        </form>
