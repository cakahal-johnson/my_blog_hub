        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h3 class="text-dark">Manage Blog Topics</h3>
                    ...
                    <div class="table-responsive">    
                        <table class="table table-striped table-borderless table-primary  table-hover">
                            <thead>
                                <th>SN</th>
                                <th>Name</th>
                            ...
                            <tbody>
                                <?php foreach ($topics as $key => $topic) : ?>
                                    <tr>
                                        ...
                                        <td><a href="edit.php?id=<?php echo $topic['id']; ?>" class="btn btn-sm btn-outline-primary">edit</a></td>
                                        <td><a href="index.php?del_id=<?php echo $topic['id']; ?>" class="btn btn-sm btn-outline-danger">delete</a></td>
                                    </tr>
                                <?php endforeach; ?>
