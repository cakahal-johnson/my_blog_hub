        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h3 class="text-dark">Manage Blog Posts</h3>
                        ...
                        <table class="table table-striped table-borderless table-dark  table-hover">
                            ...
                            <?php foreach ($posts as $key => $post) : ?>
                                <tr>
                                    ...
                                    <td>Cakahal Johnson</td>
                                    <td><a href="edit.php?id=<?php echo $post['id'];?>" class="btn btn-sm btn-primary">edit</a></td>
                                    <td><a href="edit.php?delete_id=<?php echo $post['id'];?>" class="btn btn-sm btn-outline-danger">delete</a></td>

                                    <?php if($post['published']) : ?>
                                        <td><a href="edit.php?published=0&p_id=<?php echo $post['id'] ?>" class="btn btn-sm btn-outline-warning">unpublish</a></td>
                                    <?php else: ?>
                                        
                                        <td><a href="edit.php?published=1&p_id=<?php echo $post['id'] ?>" class="btn btn-sm btn-outline-success">publish</a></td>
                                    <?php endif; ?>
                                </tr>
                            <?php endforeach; ?>
                                <!-- <tr>
                                    <td>1</td>
                                    <td>Poetry is the Second post of the day</td>
                                    <td>Johnson Guest</td>
                                    <td><a href="" class="btn btn-sm btn-primary">edit</a></td>
                                    <td><a href="" class="btn btn-sm btn-outline-danger">delete</a></td>
                                    <td><a href="" class="btn btn-sm btn-outline-success">publish</a></td>
                                </tr>
                                 -->
