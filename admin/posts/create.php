            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        ...
                        <h3 class="text-dark">Create Posts</h3>
                        ...
                        <!-- FORM SECTIONS STARTS HERE -->
                        <form method="POST" action="create.php" enctype="multipart/form-data" class="container">
                            ...
                            <button type="submit" name="add_post" class="btn mb-4 btn-primary">Submit Comment</button>
                        </form>
